...
import 'dart:async';
import 'package:emprega_unitins/screens/detalhe_vaga_antiga/detalhe_vaga_antiga.dart';
...
class BodyState extends State<Body> {
  ...
  Future<List<Vaga>> getVagasList() async {
    List<Vaga> dados;
    var url = Uri.parse(caminho+'vagasantigas.php');
                              ...
                              Row(
                                ...
                                children: <Widget>[
                                  ...
                                  TextButton(
                                    ...
                                    onPressed: () {
                                      Navigator.push(context, MaterialPageRoute(builder: (context) => DetalheVagaAntiga(id: id))).then(naVolta);
                                    },
                                  ),
                                  const SizedBox(width: 8),
                                ],
