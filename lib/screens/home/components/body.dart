...
import 'package:emprega_unitins/screens/detalhe_vaga/detalhe_vaga.dart';
import 'dart:async';
...
class BodyState extends State<Body> {
  ...
  Future<List<Vaga>> getVagasList() async {
    List<Vaga> dados;
    var url = Uri.parse(caminho+'vagas.php');
                              ...
                              Row(
                                ...
                                children: <Widget>[
                                  TextButton(
                                    ...
                                    onPressed: () {
                                      Navigator.push(context, MaterialPageRoute(builder: (context) => DetalheVaga(id_vaga: id, id_pessoa: id_pessoa))).then(naVolta);
                                    },
                                  ),
